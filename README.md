...
### Tools & Platforms
![Firefox](https://img.shields.io/badge/WebExtensions-FF7139?style=for-the-badge&logo=firefox-browser&logoColor=white)
...
### Messaging & APIs
![SMTP](https://img.shields.io/badge/SMTP-DD4B39?style=for-the-badge&logo=gmail&logoColor=white)
...
|---|---------|-------------|------|-------|
| 🚀 | [**OmniSend Pro**](https://github.com/zougar99/omnisend-pro) | Multi-channel bulk messaging (Email, WhatsApp, SMS, Telegram) | ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat&logo=python&logoColor=white) | ![Stars](https://img.shields.io/github/stars/zougar99/omnisend-pro?style=flat&color=yellow) |
| 🦊 | **Firefox Extensions** | WebExtensions published on Mozilla AMO | ![JS](https://img.shields.io/badge/-JavaScript-F7DF1E?style=flat&logo=javascript&logoColor=black) | [View on AMO](https://addons.mozilla.org/en-US/firefox/user/19705561/) |
| ✍️ | [**Tech Blog**](https://werlist99.blogspot.com/) | Windows optimization & troubleshooting guides | ![Blogger](https://img.shields.io/badge/-Blogger-FF5722?style=flat&logo=blogger&logoColor=white) | — |
| 📦 | [**Extensions Hub**](https://extefw99.blogspot.com/) | Firefox add-ons catalog & documentation | ![Web](https://img.shields.io/badge/-Web-4285F4?style=flat&logo=google-chrome&logoColor=white) | — |
...
![Profile Views](https://komarev.com/ghpvc/?username=zougar99&color=blueviolet&style=for-the-badge&label=PROFILE+VIEWS)
